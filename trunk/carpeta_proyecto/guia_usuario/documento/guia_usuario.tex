...
\input{tex/02_0_guia_user}

\subsection{Página principal}
\input{tex/02_1_pagina_principal_user}

\subsection{Listado completo de microcontroladores}
\input{tex/02_2_listado_completo_user}

\subsection{Carrito de compra}
\input{tex/02_3_carrito_compra}

\subsection{Generación de pedido}
\input{tex/02_4_generacion_pedido}
...
\input{tex/03_0_guia_admin}

\subsection{Página principal}
\input{tex/03_1_pagina_principal_admin}

\subsection{Listado completo de microcontroladores}
\input{tex/03_2_listado_completo_admin}

\subsection{Añadir microcontrolador}
\input{tex/03_3_anyadir_micro}
