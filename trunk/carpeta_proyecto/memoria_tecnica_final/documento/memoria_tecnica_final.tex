...
\input{tex/01_0_introduccion}

% 01.1
\subsection{Identificación del proyecto}
\input{tex/01_1_identificacion_del_proyecto.tex}

% 01.1
\subsection{Objetivo y alcanze}
\input{tex/01_2_objetivo_y_alcanze_del_proyecto.tex}

% 01.1
\subsection{Identificación del equipo}
\input{tex/01_3_identificacion_del_equipo.tex}

% 01.4
\subsection{Descripción del contenido}
\input{tex/01_4_descripcion_del_contenido.tex}
...
\input{tex/02_0_requisitos_del_sistema.tex}
...
\input{tex/03_0_descripcion_tecnica.tex}

% 03.1
\subsection{Aspectos arquitecturales y tecnológicos}
\input{tex/03_1_aspectos_arquitecturales_y_tecnologicos.tex}

% 03.2
\subsection{Modelos de datos}
\input{tex/03_2_modelos_de_datos.tex}

% 03.3
\subsection{Diseño de los componentes}
\input{tex/03_3_diseno_de_componentes_del_sistema.tex}
...
\input{tex/04_0_verificacion_y_validacion.tex}

% 04.1
\subsection{Metodología de pruebas}
\input{tex/04_1_descripcion_de_metodologia_de_pruebas.tex}

% 04.2
\subsection{Pruebas. Defectos. Correcciones}
\input{tex/04_2_pruebas_realizadas_cambios_correcciones.tex}
...
% 05
\section{Manuales}
\input{tex/05_0_manuales.tex}

% 05.1
\subsection{Manual de usuario}
\input{tex/05_1_manual_de_usuario.tex}

% 05.2
\subsection{Manual de instalación}
\input{tex/05_2_manual_de_instalacion.tex}
...
\input{tex/06_0_0_gestion_del_proyecto.tex}

% 06.1
\subsection{Fases y actividades}
\input{tex/06_1_0_fases_y_actividades_del_proyecto.tex}

% 06.1.1
\subsubsection{Riesgos}
\input{tex/06_1_1_riesgos.tex}

% 06.1.2
\subsubsection{Estimaciones iniciales}
\input{tex/06_1_2_estimaciones_globales_de_tamanos_y_esfuerzos_iniciales.tex}

% 06.1.3
\subsubsection{Cronogramas}
\input{tex/06_1_3_cronogramas_global_inicial_y_final.tex}

% 06.1.4
\subsubsection{Tareas y estimación de esfuerzos}
\input{tex/06_1_4_tareas_y_estimaciones_de_esfuerzos_por_iteracion.tex}

% 06.1.5
\subsubsection{Ficheros de esfuerzos individuales}
\input{tex/06_1_5_ficheros_de_esfuerzos_individuales.tex}

% 06.1.6
\subsubsection{Esfuerzos reales de las tareas}
\input{tex/06_1_6_esfuerzos_reales_de_las_tareas_por_iteracion.tex}

% 06.1.7
\subsubsection{Esfuerzos reales de las personas}
\input{tex/06_1_7_esfuerzos_reales_de_las_personas_y_roles.tex}

% 06.2
\subsection{Procesos de seguimiento y control}
\input{tex/06_2_0_procesos_de_seguimiento_y_control.tex}

% 06.2.1
\subsubsection{Calendario de reuniones}
\input{tex/06_2_1_calendario_de_las_distintas_reuniones_celebradas.tex}

% 06.2.2
\subsubsection{Actas de reuniones}
\input{tex/06_2_3_actas_de_las_distintas_reuniones_celebradas.tex}

% 06.3
\subsection{Coste}
\input{tex/06_3_0_coste_real_del_proyecto.tex}
...
\input{tex/07_0_gestion_de_configuraciones_del_proyecto.tex}

% 07.1
\subsection{Políticas de nombrado}
\input{tex/07_1_politicas_de_nombrado.tex}

% 07.2
\subsection{Control de versiones}
\input{tex/07_2_control_de_versiones.tex}

% 07.3
\subsection{Copias de seguridad}
\input{tex/07_3_copias_de_seguridad.tex}

% 07.4
\subsection{Elementos de configuración y línea base}
\input{tex/07_4_elementos_de_configuracion_y_linea_base.tex}
...
\input{tex/08_0_aseguramiento_de_la_calidad_del_proyecto.tex}

% 08.1
\subsection{Estándares utilizados}
\input{tex/08_1_estandares_utilizados.tex}

% 08.2
\subsection{Planificación de las auditorías}
\input{tex/08_2_planificacion_de_las_auditorias.tex}

% 08.3
\subsection{Auditorías}
\input{tex/08_3_auditorias.tex}

% 08.4
\subsection{Auditoría externa}
\input{tex/08_4_auditoria_externa.tex}

% 08.5
\subsection{No conformidades}
\input{tex/08_5_no_conformidades.tex}
...
% 09
\section{Postmortem}
\input{tex/09_0_postmortem_del_proyecto.tex}

% 09.1
\subsection{Lecciones aprendidas}
\input{tex/09_1_lecciones_aprendidas.tex}

% 09.2
\subsection{Problemas encontrados}
\input{tex/09_2_problemas_encontrados.tex}

% 09.3
\subsection{Catálogo de riesgos}
\input{tex/09_3_catalogo_de_riesgos.tex}

% 09.4
\subsection{Diferencias entre los esfuerzos y tamaños reales y los estimados}
\input{tex/09_4_analisis_esfuerzos_y_tamano_estimados_vs_reales.tex}

% 09.5
\subsection{Plan real vs planificación inicial}
\input{tex/09_5_plan_real_vs_planificacion_inicial.tex}

% 09.6
\subsection{Diferencias entre el coste real y el presupuesto}
\input{tex/09_6_analisis_coste_real_vs_presupuesto.tex}
...
\input{tex/10_0_conclusiones.tex}

% 10.1
\subsection{Conclusiones del proyecto}
\input{tex/10_1_conclusiones_del_proyecto.tex}

% 10.2
\subsection{Ideas de mejora del proceso}
\input{tex/10_2_ideas_de_mejora_de_proceso.tex}

% 10.3
\subsection{Ideas de mejora del desarrollo del proyecto dentro de la asignatura}
\input{tex/10_3_ideas_de_mejora_del_desarrollo_del_proyecto_dentro_de_asignatura.tex}

% 10.4
\subsection{Valoraciones subjetivas}
\input{tex/10_4_valoraciones_subjetivas_argumentadas.tex}
...
\input{tex/a_0_curriculums_vitae.tex}

% A.1
\subsection{CV: Daniel García Páez}
\input{tex/a_1_cv_daniel.tex}
\newpage

% A.2
\subsection{CV: Javier Briz Alastrué}
\input{tex/a_2_cv_javier.tex}
\newpage
...
\input{tex/a_4_cv_alejandro.tex}
\newpage
...
% F
%\section{Auditorías}
%\label{anex:Auditorias}
%\input{tex/f_0_auditorias.tex}
...
% G
%\section{Manuales}
%\input{tex/g_0_manuales.tex}

% G.1
%\subsection{Manual de usuario}
%\input{tex/g_1_manual_de_usuario.tex}
%En el \manualUsuario{guia_usuario}{siguiente enlace} se puede encontrar el manual de usuario tanto para el cliente habitual del catálogo electronico como para el administrador del mismo.

% G.2
%\subsection{Manual de instalación}
%\input{tex/g_2_manual_de_instalacion.tex}
...
%\input{tex/h_0_informes_pruebas.tex}
\paragraph{}En el \hojaesfuerzos{usearch_pruebas_sistema}{siguiente enlace} se puede acceder al informe completo de pruebas de sistema.

\paragraph{}En el \hojaesfuerzos{resultados_w3c_validator}{siguiente enlace} se puede acceder al informe de las pruebas realizadas sobre la vista de la aplicación con el \textit{W3C Validator}.
