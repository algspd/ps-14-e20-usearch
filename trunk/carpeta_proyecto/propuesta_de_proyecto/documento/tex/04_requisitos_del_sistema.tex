...
\item Se permitirá realizar búsquedas de productos en base a un único campo de búsqueda (una y solo una de las caracterísitcas de los elementos).
...
\item Los listados de elementos del catálogo estarán ordenados en baso al campo arquitectura del elemento.
