...
\itemNvlUno{Se unificaron las reuniones de planificación, gestión, etc. en reuniones no técnicas y reuniones técnicas, de tal forma que solamente habrá esta división.} 
...
\itemNvlDos{\emph{Tarea 4}: Gestión de pedidos, primera versión sin generar PDF.}
\itemNvlDos{La vista (interfaz web) se desarrollará en el momento conforme se vaya necesitando y quien lo necesite.}

\itemNvlUno{Estimación conjunta de esfuerzos:}
...
\itemNvlUno{Se deja para la segunda iteración la sección de administración del catálogo.}
